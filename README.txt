...
- _old_Point3D.h: (NO SE USA, USADO EN LA PRIMERA PRÁCTICA) clase para interpretar un punto en el espacio, ha sido sustituída por "vertex.h"
- _old_Triangle.h: (NO SE USA, USADO EN LA PRIMERA PRÁCTICA) clase para interpretar una cara en el espacio, ha sido sustituída por "vertex.h"
